...
impl<'a> Iterator for PathIter<'a> {
    ...
    /// move:  [`PathIterRec::points()`]`[0]`
    /// line:  [`PathIterRec::points()`]`[0..1]`
    /// quad:  [`PathIterRec::points()`]`[0..2]`
    /// conic: [`PathIterRec::points()`]`[0..2]` [`PathIterRec::conic_weight()`]
    /// cubic: [`PathIterRec::points()`]`[0..3]`
    /// close: [`PathIterRec::points()`]`[0..1]` ... as if close were a line from `pts[0]` to `pts[1]`
